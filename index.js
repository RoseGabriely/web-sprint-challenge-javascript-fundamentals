...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    const totalPop = array.reduce(function(sum, item){
...
*/
function CuboidMaker(propertiesObj){
  this.length = propertiesObj.length;
  this.width = propertiesObj.width;
  this.height = propertiesObj.height;
}
